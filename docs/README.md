...
| Build v0.5 simulation and embodiment support | [Approved multi-agent completion plan](releases/v0.5/completion-plan-2026-09-09.md) | [Execution checkpoint](releases/v0.5/execution-2026-09-09.md), [canonical contracts](contracts/v0.5/README.md), [index and three audits](releases/v0.5/README.md); M0 merged, wave 1 implementation active |
