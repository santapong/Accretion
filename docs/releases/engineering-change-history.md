# Engineering change history through v0.4.1

This archive retains the complete released engineering entries from the root
`CHANGELOG.md` at commit `306d8dc60aa72ba07bb8181aa59c35eb94191f61` (9 September
2026). Relative document links were adjusted for this location. Individual
milestone entries describe their state when written; later amendments and
releases may supersede an earlier draft or pending status.

Use the [current changelog](../../CHANGELOG.md) for concise release summaries
and changes awaiting release. Frozen protocols, baselines and audit evidence
