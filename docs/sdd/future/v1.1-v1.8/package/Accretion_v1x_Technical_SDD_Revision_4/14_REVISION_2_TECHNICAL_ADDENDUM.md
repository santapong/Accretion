> Retained foundation: Revision 4 preserves these authority/lifecycle rules. Current schema versions, research additions and validation are in documents 28–32; the untouched historical addendum is under `history/revision-3/`.
