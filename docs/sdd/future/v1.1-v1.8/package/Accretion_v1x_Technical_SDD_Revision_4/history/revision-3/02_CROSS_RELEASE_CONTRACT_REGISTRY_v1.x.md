...
## 21. Revision-3 shared research contract ownership
...
| `ObservableInterventionRecord` | v1.3 recovery research | Distinguish deterministic re-execution from prediction-only counterfactuals | Predicted outcome is not causal proof |
