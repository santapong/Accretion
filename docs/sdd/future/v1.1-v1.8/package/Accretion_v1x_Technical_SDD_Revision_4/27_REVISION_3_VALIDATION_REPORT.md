> Historical record: this describes an earlier revision, not current validation or readiness. The original files are under `history/revision-3/`; Revision 4 is governed by documents 28–32.
