...
### 19.1 Revision-3 profile-only pilot
...
For planning only, an initial feasibility design may use 12 development tasks and six project-disjoint holdout tasks spanning at least six project lineages. A 20–24 profile-trial development cap plus 18 holdout profile trials yields 38–42 total profile trials before repeats, retries or verifier qualification. Those quantities are assumptions to validate from the trace inventory, not acceptance thresholds. The frozen protocol must justify any replacement.
...
|---|---|---|
| C1 | TTVS contract and trace instrumentation | Clock/trace conformance and replay tests |
...
| C-OQ2 | Success confidence method | Bootstrap/conformal lower bound selected by calibration study | Protocol freeze |
