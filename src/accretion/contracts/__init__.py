...
class EventType(StrEnum):
    ...
    # SDD v0.4 section 12 routing, feedback and router events. All twelve are declared once,
    # here, in M1 so that no later v0.4 PR has to touch this generated enum (and therefore
    # `openapi.json` and `apps/ui/src/api/schema.d.ts`) a second time.
    ROUTING_REQUESTED = "ROUTING_REQUESTED"
    ROUTING_CANDIDATES_BUILT = "ROUTING_CANDIDATES_BUILT"
    ROUTING_DECISION_CREATED = "ROUTING_DECISION_CREATED"
    ROUTING_OVERRIDE_RECORDED = "ROUTING_OVERRIDE_RECORDED"
    ROUTING_FALLBACK_SELECTED = "ROUTING_FALLBACK_SELECTED"
    ROUTING_HUMAN_REVIEW_REQUIRED = "ROUTING_HUMAN_REVIEW_REQUIRED"
    VERIFICATION_RESULT_RECORDED = "VERIFICATION_RESULT_RECORDED"
    EXPERIENCE_CREATED = "EXPERIENCE_CREATED"
    ROUTER_CANDIDATE_TRAINED = "ROUTER_CANDIDATE_TRAINED"
    ROUTER_PROMOTION_EVALUATED = "ROUTER_PROMOTION_EVALUATED"
    ROUTER_VERSION_PROMOTED = "ROUTER_VERSION_PROMOTED"
    ROUTER_VERSION_ROLLED_BACK = "ROUTER_VERSION_ROLLED_BACK"
